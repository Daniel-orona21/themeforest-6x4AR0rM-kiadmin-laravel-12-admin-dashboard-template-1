                    ...
                    <div class="card-body">
                        <div class="d-flex gap-3 flex-wrap">
                            <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden text-bg-primary">
                                <img src="{{asset('assets/images/avatar/logo1.png')}}" alt="avatar" class="img-fluid">
                            </div>
                ...
                <div class="card equal-card">
                    ...
                    <div class="card-body">
                      ...
                      <span class="bg-danger h-45 w-45 d-flex-center b-r-50 position-relative">
                        ...
                        <img src="{{asset('assets/images/avatar/logo1.png')}}" alt="avatar" class="img-fluid b-r-50">
                        <span
                        ...
                        <div class="d-flex gap-3 flex-wrap">
                          ...
                          <span
                              class="position-absolute top-0 start-2 p-1 bg-success border border-light rounded-circle"></span>
                                    <img src="{{asset('assets/images/avatar/logo1.png')}}" alt="avatar" class="img-fluid b-r-50 overflow-hidden">
                                </li>
